...
data_settings = {
    'MP': {'data': 'MP_new_date.csv', 'T': 'OT', 'M': [11, 11], 'S': [1, 1], 'MS': [11, 1], 'prefetch_batch_size': 64},
    'Manufacturing': {'data': 'Manufacturing_new.csv', 'T': 'OT', 'M': [6, 6], 'S': [1, 1], 'MS': [6, 1], 'prefetch_batch_size': 64},
    'Production': {'data': 'Production_small.csv', 'T': 'OT', 'M': [18, 18], 'S': [1, 1], 'MS': [18, 1], 'prefetch_batch_size': 64},
    'Mining': {'data': 'Mining_small.csv', 'T': 'OT', 'M': [8, 8], 'S': [1, 1], 'MS': [8, 1], 'prefetch_batch_size': 64}
}
